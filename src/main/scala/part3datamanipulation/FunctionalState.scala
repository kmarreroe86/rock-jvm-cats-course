...
object FunctionalState {
  ...
  // state = "iterative" computations (no mutations)
  ...
  def main(args: Array[String]): Unit = {
    ...
    // println(compositeTransormation.run(10).value)
    // println(compositeTransormation2.run(10).value)
...
// https://rockthejvm.com/courses/1107955/lectures/23728910
