...
object DataValidation {
  ...
  val aValidValue: Validated[String, Int] =
    Validated.valid(42) // "right" value in an Either
  val anInvalidValue: Validated[String, Int] = Validated.invalid(
    "Something went wrong"
  ) // "left" value, undesired value in an Either
  ...
  val tryToValidated: Validated[Throwable, Int] =
    Validated.fromTry(Try("something".toInt))
