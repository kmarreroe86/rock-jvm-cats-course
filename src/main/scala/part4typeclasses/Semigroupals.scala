...
object Semigroupals {
  ...
  val noneTupled: Option[(Nothing, Int)] = optionSemigroupal.product(None, Some(123)) // None
  ...
  def main(args: Array[String]): Unit = {
    println(s"aTupledOption = ${aTupledOption}")
    println(s"noneTupled = ${noneTupled}")
...
// https://rockthejvm.com/courses/1107955/lectures/23728912
